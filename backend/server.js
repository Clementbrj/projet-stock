...
// --
//  Create---------------------------------------
app.post('/founissseur/create', (req, res) => {
    const { nom } = req.query;
  ...
  //  Update---------------------------------------
  app.put('/founissseur/update/:id', (req, res) => {
    const { id } = req.params;
  ...
  //  Delete---------------------------------------
  app.delete('/founissseur/delete/:id', (req, res) => {
    const { id } = req.params;
